...
export const STANDARD_POSITIONS = [
  {
    category: 'Executive & Society Leadership',
    positions: [
      'President',
      'Vice President',
      'Tech Lead',
  ...
  {
    category: 'Domain Leadership (Leads & Assistant Leads)',
    positions: [
      'Domain Lead',
      'Asst. Domain Lead',
      'Web Dev Lead',
      ...
      'Asst. AI/ML Lead',
      'Mobile App Lead',
      'Asst. Mobile App Lead',
      'Cloud & DevOps Lead',
      'Asst. Cloud & DevOps Lead',
      'CP & DSA Lead',
      'Asst. CP & DSA Lead',
      'UI/UX Design Lead',
      'Asst. UI/UX Design Lead',
      'Management & PR Lead',
      'Asst. Management & PR Lead',
    ],
  },
  {
    category: 'Core & Domain Members',
    positions: [
      'Core Member',
